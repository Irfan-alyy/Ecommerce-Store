...
const About = () => {
  return (
    <div className='gap-8 mb-10 pb-10 flex items-center flex-col overflow-y-hidden'>
      <header className='w-[100%] h-[80px] flex justify-center items-center' style={{backgroundColor:"rgb(247,247,247)"}}>
      <NavLink to="/Ecommerce-Store">
        <h1 className='text-2xl  text-gray-700 '>HOME <span className='font-semibold text-gray-700'>/ ABOUT US</span></h1>
        </NavLink>  
...
<hr className='text-black w-[100px] mt-4 ' style={{color:"black", width:"100px" , fontSize:"30px"    }}></hr>
...
<p className='text-start'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, obcaecati. Iste ab error, facilis ipsam omnis temporibus autem minus, beatae aut dignissimos dolore. Debitis necessitatibus vero excepturi doloremque. Repellat, nihil?</p>
</div>
...
<section className='flex px-10  justify-between items-center flex-col w-full py-8 sm:grid sm:grid-cols-2  md:grid md:grid-cols-2 lg:flex lg:flex-row  lg:px-10      ' style={{backgroundColor:"rgb(247,247,247)"}}>

<div className='flex justify-center items-center flex-col mb-4'>
<a href=""  className='mb-4'><RiProjectorLine style={{fontSize:"59px "}}/></a>
<h3 className='text-4xl text-bold font-bold mb-4 ' style={{color:"rgb(167,73,255)"}}>360</h3>
<h4 className='text-2xl'>Project Done</h4>
</div>

<div className='flex justify-center items-center flex-col mb-4'>
<a href=""  className='mb-4'><TfiCup style={{fontSize:"59px "}}/></a>
<h3 className='text-4xl text-bold font-bold mb-4 ' style={{color:"rgb(167,73,255)"}}>690</h3>
<h4 className='text-2xl'>Cup Of Coffe</h4>
</div>

<div className='flex justify-center items-center flex-col mb-4'>
<a href=""  className='mb-4'><HiOutlineLightBulb  style={{fontSize:"59px "}}/></a>
<h3 className='text-4xl text-bold font-bold mb-4 ' style={{color:"rgb(167,73,255)"}}>100</h3>
<h4 className='text-2xl'>Branding</h4>
</div>

<div className='flex justify-center items-center flex-col mb-4'>
<a href=""  className='mb-4'><CiFaceSmile  style={{fontSize:"59px "}}/></a>
<h3 className='text-4xl text-bold font-bold mb-4 ' style={{color:"rgb(167,73,255)"}}>420</h3>
...
<div className='flex justify-center items-center flex-col  bg-gray-100 pb-4'>
<img src="https://flone.jamstacktemplates.dev/assets/img/team/team-3.jpg" alt="" className='w-[80%] mb-5 '/>
<h3>Mr.Peter Pan</h3>
<h4>developer</h4>
</div>

<div className='flex justify-center items-center flex-col  bg-gray-100 pb-4'>
<img src="https://flone.jamstacktemplates.dev/assets/img/team/team-4.jpg" alt="" className='w-[80%] mb-5 '/>
<h3>Mr.Mike Banding</h3>
<h4>Develpoper</h4>
</div>
...
<section className='flex justify-center items-center flex-row gap-10    '>
  ...
  <img src="https://flone.jamstacktemplates.dev/assets/img/brand-logo/brand-logo-1.png" alt="" className='' />
  <img src="https://flone.jamstacktemplates.dev/assets/img/brand-logo/brand-logo-3.png" alt=""  className=''/>
  <img src="https://flone.jamstacktemplates.dev/assets/img/brand-logo/brand-logo-5.png" alt=""  className='hidden md:block'/>
